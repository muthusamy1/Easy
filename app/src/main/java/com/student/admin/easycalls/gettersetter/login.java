...
public class login {
    ...
    public class LoginDetails
    {
        ...
        public String toString()
        {
            return "ClassPojo [employee_email = "+employee_email+", employee_type = "+employee_type+", employee_position = "+employee_position+", employee_name = "+employee_name+", Id = "+Id+", employee_phone = "+employee_phone+"]";
        }
    }
